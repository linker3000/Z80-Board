...
Const
  ...
  xMax          : Byte = 80;
  yMax          : Byte = 25;
  snakeBodyANSI : String[8] = #27'[40m';
  foodANSI      : String[8] = #27'[33;40m'; {Yellow on black background}
  snakeHeadANSI : String[8] = #27'[40m';
  borderANSI    : String[8] = #27'[31;44m';
  resetANSI     : String[4] = #27'[0m';     {Reset ANSI attributes}
  msgANSI       : String[8] = #27'[33;40m';
...
begin
   clrscr;
   write (msgANSI);
   writeCtr( 4,'SNAKE v0.3T (c) 2018, Karl A. Brokstad (www.Z80.no)');
   writeCtr( 5,'Turbo Pascal version by Linker3000');
   ...
   writeCtr(15,'ANSI/VT100 compatible console');
   writeCtr(16,'Screen size 80x25');
   writeCtr(18,'Movement:');
   writeCtr(20,'Z = left, X = up, N = down, M = right OR use WASD keys');
   writeCtr(21,'# = Quit to here during game');
   writeCtr(23,'Press RETURN to START or Q to QUIT');
   repeat
